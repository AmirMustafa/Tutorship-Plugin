...
$string['configbreaktimeslot'] = 'Break time slot length, the number of minutes per interview session.';
...
$string['friday'] = 'Fri';
$string['fridayfull'] = 'Friday';
$string['saturday'] = 'Sat';
$string['saturdayfull'] = 'Saturday';
$string['sunday'] = 'Sun';
$string['sundayfull'] = 'Sunday';
...
$string['notutorships'] = 'No tutorships';
...
$string['thursday'] = 'Thu';
$string['thursdayfull'] = 'Thursday';
$string['timeslotlength'] = 'Time slot length (minutes)';
$string['breaktimelength'] = 'Break Time length (minutes)';
$string['timetable'] = 'Timetable settings';
$string['tuesday'] = 'Tue';
$string['tuesdayfull'] = 'Tuesday';
...
$string['tutorship:teachermanage'] = 'Tutorship TeacherManager';
$string['tutorship:leavemanage'] = 'Tutorship Leavemanager';
$string['unreserve'] = 'Unreserve';
$string['view'] = 'View';
$string['wednesday'] = 'Wed';
$string['wednesdayfull'] = 'Wednesday';
$string['year'] = 'Year';
$string['notify_startclass'] = 'Notification Email before Start Class';

//Logs
$string['eventedit_slot'] = 'Edit slot';
$string['eventreserve_slot'] = 'Reserve slot';
$string['eventunreserve_slot'] = 'Un-reserve slot';
$string['eventconfirm_slot'] = 'Confirm slot';
$string['eventcancel_slot'] = 'Cancel slot';
$string['eventedit_maxreserves'] = 'Edit max reserves';
$string['eventedit_noreserves'] = 'Edit no reserves';
$string['eventedit_confirmation'] = 'Edit confirmation';
$string['eventedit_notifications'] = 'Edit notifications';


//New strings
$string['available_teachers'] = 'Available Teachers';
