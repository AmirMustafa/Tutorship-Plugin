...
/**
 * This file keeps track of upgrades to the tutorship module.
 *
...
/**
 * xmldb_tutorship_upgrade
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_tutorship_upgrade($oldversion=0) {

    global $CFG, $THEME, $DB;

    $dbman = $DB->get_manager();

    if ($oldversion < 2014041508) {

        // Define table tutorship_calendar to be created.
        $table = new xmldb_table('tutorship_calendar');

        // Adding fields to table tutorship_calendar.
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('reserveid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('subid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('timemodified', XMLDB_TYPE_INTEGER, '10', null, null, null, null);

        // Adding keys to table tutorship_calendar.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));

        // Conditionally launch create table for tutorship_calendar.
        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        }

        // Tutorship savepoint reached.
        upgrade_mod_savepoint(true, 2014041508, 'tutorship');
    }
...
//if ($result && $oldversion < 2007100601) { //New version in version.php
    //$result = result of "/lib/ddllib.php" function calls

    /// Define field description to be added to tutorship
//    $table = new XMLDBTable('tutorship');
//    $field = new XMLDBField('description');
//    $field->setAttributes(XMLDB_TYPE_TEXT, 'small', null, XMLDB_NOTNULL, null, null, null, null, 'description');

    /// Launch add field description
//    $result = $result && add_field($table, $field);

    /// Define field name to be dropped from tutorship
//    $table = new XMLDBTable('tutorship');
//    $field = new XMLDBField('description');

    /// Launch drop field name
...
/// for demonstrative purposes and to show how the tutorship
/// iself has been upgraded.

/// For each upgrade block, the file tutorship/version.php
...
//    if ($result && $oldversion < 2007040100) {
    ...
    /// Define field course to be added to tutorship
//        $table = new XMLDBTable('tutorship');
...
//        $result = $result && add_field($table, $field);
    ...
    /// Define field intro to be added to tutorship
//        $table = new XMLDBTable('tutorship');
...
//        $result = $result && add_field($table, $field);
    ...
    /// Define field introformat to be added to tutorship
//        $table = new XMLDBTable('tutorship');
...
//    if ($result && $oldversion < 2007040101) {
    ...
    /// Define field timecreated to be added to tutorship
//        $table = new XMLDBTable('tutorship');
...
//        $result = $result && add_field($table, $field);
    ...
    /// Define field timemodified to be added to tutorship
//        $table = new XMLDBTable('tutorship');
...
//        $result = $result && add_field($table, $field);
    ...
    /// Define index course (not unique) to be added to tutorship
//        $table = new XMLDBTable('tutorship');
...
//        $rec = new stdClass;
//        $rec->module = 'tutorship';
//        $rec->action = 'add';
//        $rec->mtable = 'tutorship';
//        $rec->filed  = 'name';
