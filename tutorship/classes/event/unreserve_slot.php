...
/**
 * The mod_tutorship unreserve_slot event.
 *
...
/**
 * The mod_tutorship unreserve slot event class.
 * @package    mod_tutorship
 * @since      Moodle 3.2.1
 * @copyright  2017 <moodledman@gmail.com>
 * 
 */
class unreserve_slot extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventunreserve_slot', 'mod_tutorship');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' unreserved (deleted) the slot with id '$this->objectid' in the tutorship activity " .
