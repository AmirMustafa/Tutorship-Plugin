...
/**
 * The mod_tutorship cancel_slot event.
 *
...
/**
 * The mod_tutorship cancel slot event class.
 * @package    mod_tutorship
 * @since      Moodle 3.2.1
 * @copyright  2017 <moodledman@gmail.com>
 * 
 */
class cancel_slot extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcancel_slot', 'mod_tutorship');
    }
    ...
    public function get_description() {
        ...
        return "The teacher user with id '$this->userid' cancelled the slot with id '$this->objectid' in the tutorship activity " .
