...
/**
 * The mod_tutorship edit_notifications event.
 *
 ...
 * 
 */
class edit_notifications extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventedit_notifications', 'mod_tutorship');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' updated the notifications value at '$this->objectid' in the tutorship activity " .
