...
/**
 * The mod_tutorship edit_noreserves event.
 *
 ...
 * 
 */
class edit_noreserves extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventedit_noreserves', 'mod_tutorship');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' updated the noreserves value at '$this->objectid' in the tutorship activity " .
