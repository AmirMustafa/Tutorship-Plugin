...
/**
 * The mod_tutorship reserve_slot event.
 *
...
/**
 * The mod_tutorship reserve slot event class.
 * @package    mod_tutorship
 * @since      Moodle 3.2.1
 * @copyright  2017 <moodledman@gmail.com>
 * 
 */
class reserve_slot extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreserve_slot', 'mod_tutorship');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' reserved the slot with id '$this->objectid' in the tutorship activity " .
