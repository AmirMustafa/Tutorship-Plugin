...
/**
 * The mod_tutorship edit_maxreserves event.
 *
...
/**
 * The mod_tutorship edit_maxreserves event class.
 * @package    mod_tutorship
 * @since      Moodle 3.2.1
 * @copyright  2017 <moodledman@gmail.com>
 * 
 */
class edit_maxreserves extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventedit_maxreserves', 'mod_tutorship');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' updated the maxreserves value at '$this->objectid' in the tutorship activity " .
